...
| **Play externally** | press **Play** on a programme and the channel opens straight in your device's default media app (VLC / mpv / MX Player) — a one-channel `.m3u` hand-off on desktop, an app chooser on Android, or **Copy stream URL**. No in-browser player |
